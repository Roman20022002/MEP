...
def train():
    ...
    num_qubits, d, epochs, lr, k, lamb = 5, 4, 100, 0.1, 1, 10
    ...
    init_path = f"init_thetas_10/init_{init_index}.npy"
    ...
    output_dir = f"plots10_bond_{bond_dimension}/index_{init_index}"
