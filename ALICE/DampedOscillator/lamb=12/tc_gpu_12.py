...
def train():
    ...
    num_qubits, d, epochs, lr, k, lamb = 6, 5, 100, 0.1, 1, 12
    ...
    init_path = f"init_thetas_12/init_{init_index}.npy"
    ...
    output_dir = f"plots12_bond_{bond_dimension}/index_{init_index}"
